...
// NOTE: Commented out because extending JSX.IntrinsicElements breaks TypeScript JSX inference.
// These components are only used in extensions/*.jsx files which don't use TypeScript.
/*
declare global {
  namespace JSX {
