...
export function ImageAnalyzer({
  ...
  const imagesNeedingAlt = analysis.images.filter((img) =>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <div
        style={{
          ...
          padding: "16px",
          background: analysis.criticalIssues > 0 ? "var(--color-warning-soft)" : "var(--color-success-soft)",
        ...
        >
          {analysis.images.map((image, index) => (
            <ImageCard
              ...
              onToggle={() => setExpandedImage(expandedImage === image.id ? null : image.id)}
