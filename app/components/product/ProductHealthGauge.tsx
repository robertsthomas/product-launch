    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "12px" }}>
        <div style={{ position: "relative", width: "100px", height: "100px", flexShrink: 0 }}>
          ...
          >
            <div style={{ fontSize: "24px", fontWeight: 700, color: "#18181b", lineHeight: 1 }}>{animatedPercent}%</div>
          </div>
        </div>
        ...
        <div style={{ paddingTop: "12px", borderTop: "1px solid #f4f4f5" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
            {topIssues.map((issue) => (
              <div
                key={issue.key}
                style={{ display: "flex", alignItems: "flex-start", gap: "6px", fontSize: "10px", color: "#dc2626" }}
              >
                <div
                  style={{
                    width: "3px",
