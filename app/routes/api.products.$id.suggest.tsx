...
import { type VersionSource, saveFieldVersion } from "../lib/services/version.server"
 ...
 */
export type SuggestionType = "title" | "seo_title" | "seo_description" | "description" | "tags" | "image_alt_text"
...
export const action = async ({ params, request }: ActionFunctionArgs) => {
  ...
  try {
    ...
    return Response.json({ error: "Failed to generate suggestion. Please try again." }, { status: 500 })
  }
}
