...
import { db } from "~/db"
import { type NewComplianceDrift, catalogRules, complianceDrifts, shops } from "~/db/schema"
 ...
 */
export async function resolveDrift(driftId: string, resolvedBy: "user" | "auto" | "ignored" = "user") {
  await db
