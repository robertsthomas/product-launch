...
export default extension(TARGET, (root, {i18n, data}) => {
  ...
  function updateUI() {
    ...
    if (loading) {
      ...
      inlineStack.appendChild(root.createComponent('Text', {
        appearance: "subdued"
    ...
    if (score !== null) {
      ...
      headerStack.appendChild(root.createComponent('Text', {
        fontWeight: "bold",
        size: "large"
      }, `${score}/100`));
      headerStack.appendChild(root.createComponent('Badge', {
      ...
      if (auditDetails) {
        ...
        passedStack.appendChild(root.createComponent('Text', {
          fontWeight: "bold",
          tone: "success"
        ...
        failedStack.appendChild(root.createComponent('Text', {
          fontWeight: "bold",
          tone: "critical"
        ...
        totalStack.appendChild(root.createComponent('Text', {
          fontWeight: "bold"
      ...
      emptyHeaderStack.appendChild(root.createComponent('Text', {
        fontWeight: "bold"
      }, i18n.translate("noScoreTitle")));
      emptyStack.appendChild(emptyHeaderStack);

      emptyStack.appendChild(root.createComponent('Text', {
        appearance: "subdued"
      }, i18n.translate("noScoreDescription")));

      blockStack.appendChild(emptyStack);

      const runAuditButton = root.createComponent('Button', {
        href: numericProductId ? `/apps/product-launch/app/products/${numericProductId}` : '/apps/product-launch',
        variant: "primary"
