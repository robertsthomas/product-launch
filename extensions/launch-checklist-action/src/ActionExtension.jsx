      ...
      <s-admin-action heading={i18n.translate("title")} loading={scanning}>
        <s-stack direction="block" gap="large">
          <s-stack direction="inline" gap="base">
            {product.featuredImage && <s-thumbnail src={product.featuredImage.url} alt={product.title} size="large" />}
          ...
          <s-banner tone="info">{i18n.translate("scanToCheck")}</s-banner>
        </s-stack>
    ...
    <s-admin-action heading={i18n.translate("title")} loading={scanning}>
      <s-stack direction="block" gap="large">
        <s-stack direction="inline" gap="base">
          ...
          <s-stack direction="block" gap="small">
            ...
            <s-badge tone={isReady ? "success" : "warning"}>
              {isReady ? i18n.translate("ready") : i18n.translate("needsWork", { count: audit.failedCount })}
            </s-badge>
          </s-stack>
        </s-stack>
        ...
        <s-stack direction="block" gap="small">
          ...
          {audit.items?.length > 6 && <s-text>{i18n.translate("andMore", { count: audit.items.length - 6 })}</s-text>}
        </s-stack>

        {!isReady && <s-banner tone="info">{i18n.translate("fixInApp")}</s-banner>}
      </s-stack>
